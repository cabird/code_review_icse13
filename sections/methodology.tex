...
desktop window (Figure~\ref{fig:codeflow:screenshot}). On the top left (\textbf{1}), they see the list of files
...
\begin{figure}[t] %  figure placement: here, top, bottom, or page
   \centering
   \includegraphics[width=0.98\columnwidth]{figs/codeflow.pdf}
   \caption{Screenshot of CodeFlow, the dominant code review tool used by developers at Microsoft.}
...
\begin{figure*}[t] %  figure placement: here, top, bottom, or page
   \centering
   \includegraphics[width=1.3\columnwidth]{figs/methodology.pdf}
...
Figure~\ref{fig:research-method}, collecting data from different sources for triangulation: (\textbf{1})
...
the (1) \emph{preparation phase}, participants of the card sort are selected and the
cards are created; in the (2) \emph{execution phase}, cards are sorted into meaningful
groups with a descriptive title; and in the (3) \emph{analysis phase}, abstract
...
two comments (e.g., Point 4 of Figure~\ref{fig:research-method}), from the entire dataset of CodeFlow
